...
def generate_story():
    try:
        ...
        if language == "hindi":
            ...
            prompt = f"कृपया नीचे दिए गए निर्देशों के आधार पर एक सुंदर बच्चों की कहानी हिंदी में लिखें:\n{prompt}"
        else:
...
def generate_from_photo():
    try:
        ...
        if language == "hindi":
            ...
            if name:
                prompt += f"मुख्य पात्र का नाम {name} है। "
            if ageGroup == "3–5":
            ...
            if name:
                prompt += f"The main character's name is {name}. "
            if ageGroup == "3–5":
        ...
        # Split story into pages (by sentence)
        if language == "hindi":
